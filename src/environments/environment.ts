export const environment = {
    ...
    http_protocol: 'http',
    http_separator: '://',
    api_end_point_url: '221.120.222.1',
    api_end_point_port: '9797',
    api_context_path: '',
    api_access_client: 'docyard',
    api_secret_client: 'docyard',
    firebase: {
        ...
        vapidKey: "BH5fLg0Jow4m3ftv9F-EJ1VFyy0hKplFJK8yNlMmhhAsr7R4u3M_RXY2kQTLqOOvqbyHNxfuZcx87IVybrwt4xw"
    }
};
